...
pub const VERIFICATION_KEY_PATH_PRIV: &str = formatcp!("{BASE_HOSTING_PATH}/verification-key.priv");
pub const VERIFICATION_KEY_PATH_PUB: &str = formatcp!("{BASE_HOSTING_PATH}/verification-key.pub");
